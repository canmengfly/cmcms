...
cm_base::load_common('lib/content_form'.EXT, 'admin');
...
class content extends common {
	...
	public function edit() {
		...
		if(isset($_POST['dosubmit'])) {
			...
			$tags = D('tag_content')->alias('a')->field('tag')->join('cmcms_tag b ON a.tagid=b.id', 'LEFT')->where(array('modelid'=>$modelid, 'aid'=> $id))->order('id ASC')->select();
