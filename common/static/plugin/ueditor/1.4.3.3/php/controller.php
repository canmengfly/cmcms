...
define('cmPHP_PATH', $document_root.$web_path);

include cmPHP_PATH.'cmphp'.DIRECTORY_SEPARATOR.'core'.DIRECTORY_SEPARATOR.'class'.DIRECTORY_SEPARATOR.'image.class.php';
